...
@Entity
@Table(name = "film_actor", schema = "lab08DB", catalog = "")
...
public class FilmActor {
    ...
    public boolean equals(Object o) {
        ...
        if (actorId != filmActor.actorId)
            return false;
        if (filmId != filmActor.filmId)
            return false;
        if (lastUpdate != null ? !lastUpdate.equals(filmActor.lastUpdate) : filmActor.lastUpdate != null)
            return false;
