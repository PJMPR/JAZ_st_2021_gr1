...
public class Film {
    ...
    public boolean equals(Object o) {
        ...
        if (filmId != film.filmId)
            return false;
        if (releaseYear != film.releaseYear)
            return false;
        ...
        if (description != null ? !description.equals(film.description) : film.description != null)
            return false;
        if (rating != null ? !rating.equals(film.rating) : film.rating != null)
            return false;
        if (lastUpdate != null ? !lastUpdate.equals(film.lastUpdate) : film.lastUpdate != null)
            return false;
